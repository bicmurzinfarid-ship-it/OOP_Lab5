...
public class ArrayTabulatedFunction implements TabulatedFunction,Externalizable,Cloneable {
    ...
    public String toString() {
        ...
        for (int i = 0; i < size; i++) {
            points[i] = "(" + this.getPointX(i) + ";" + getPointY(i) + ")";
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TabulatedFunction) {
            ...
            for(int i = 0;i<size;i++){
                if (Math.abs(this.getPointX(i) - that.getPointX(i)) > EPSILON ||
    ...
    public int hashCode() {
        int Hash = size*31;
        for(int i = 0; i<size; i++){
            Hash = Hash*31+this.getPoint(i).hashCode();
        }
        return Hash;
    }
    ...
    public Object clone(){
        ...
        for (int i = 0; i<size; i++){
            array[i] = (FunctionPoint)this.getPoint(i).clone();
        }
